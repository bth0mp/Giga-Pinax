...
dist/brave/
dist/firefox/
dist/giga-pinax-brave-0.12.0.zip
dist/giga-pinax-firefox-0.12.0.zip
```
...
1. Use `dist/brave`, or unzip `dist/giga-pinax-brave-0.12.0.zip` into its own folder.
...
4. Choose `dist/firefox/manifest.json`, or `dist/giga-pinax-firefox-0.12.0.zip`.
...
- Select **RIC I² Nero 306** on any web page, right-click and choose **Look up “RIC I² Nero 306” in Giga Pinax**.
...
- **Bop Euthydemus I 24A** — a bronze of Euthydemus I of Bactria; the card shows its BIGR type and the citation **Bopearachchi Euthydème I 24A**, and its acsearch search starts as "Euthydemus Bopearachchi 24A". **Bop 9C** alone lists every king with a 9C series to choose from.
