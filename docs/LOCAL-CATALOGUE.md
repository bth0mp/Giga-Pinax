...
Of the 21 mint concepts in the tracked snapshot, 13 carry a modern name that differs from the section RIC files them under. The other 8 keep RIC's own spelling: Alexandria, Aquileia, Carthage and Ostia already are the name on the map, and Londinium, Lugdunum, Mediolanum and Ticinum are not, but Nomisma publishes no other name for them. "London", "Lyons" and "Pavia" appear in no label of any language in the snapshot; "Milan" appears only as the Italian "Milano", in the Danish, Romanian and Turkish labels; and the Italian label for Ticinum is the title of an encyclopaedia article, "Storia di Pavia", rather than a name of the place. None of them was invented, so a lot written "London" or "Lyon" is still looked up by RIC's spelling — Londinium, Lugdunum, Mediolanum, Ticinum — and reaching them by the modern name needs a source that carries it.
